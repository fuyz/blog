...
/* 设置了静态文件目录为 public 文件夹，所以在index.ejs代码中的:
    href='/stylesheets/style.css' 就相当于 href='public/stylesheets/style.css' 。*/
...
//     res.render('reg', { title: '注册2' });
// });
// app.post('/reg', function (req, res) {
// });
app.get('/login', function (req, res) {
    res.render('login', {title: '登录1'});
});
